...
public class ClasspathWidgetFactory {
    ...
    public void build(ParentWidget parentWidget, List<String> dependencies) throws Exception {
        build(parentWidget, StringUtil.join(File.pathSeparator, dependencies));
    }
    ...
    public void build(ParentWidget parentWidget, String dependency) throws Exception {
        ...
        new BreakWidget(parentWidget);

    }

    private static class BreakWidget extends WikiWidget {
        protected BreakWidget(ParentWidget parentWidget) {
            super(parentWidget);
        }
